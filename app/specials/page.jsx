                ...
                <div className="container">
                    ...
                    <div className="specials-grid fade-in">
                        <a href="tel:214-307-4264" className="special-card">
                            <Image src="https://placehold.co/800x600/png" alt="Special Offer 1" width={800} height={550} />
                        </a>
                        <a href="tel:214-307-4264" className="special-card">
                            <Image src="https://placehold.co/800x600/png" alt="Special Offer 2" width={800} height={550} />
                        </a>
                        <a href="tel:214-307-4264" className="special-card">
                            <Image src="https://placehold.co/800x600/png" alt="Special Offer 3" width={800} height={550} />
                        </a>
                    </div>
