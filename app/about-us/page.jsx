                ...
                <div className="container">
                    <div className="content-two-col">
                        <div className="content-text fade-in-left">
                            ...
                            <h2>Built on a Mission That Matters</h2>
                ...
                <div className="container">
                    <div className="content-two-col reverse">
                        ...
                        <div className="content-text fade-in-right">
                            ...
                            <h2>Our Values</h2>
                            <p>Honesty is at the center of every conversation we have. Homeowners deserve straight answers, clear explanations, and recommendations that put their long-term needs first.</p>
                            ...
                            <p>Respect for time is another foundational value. That&apos;s why our approach has always prioritized fast response, thoughtful communication, and efficient, thorough workmanship.</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="content-two-col">
                        <div className="content-text fade-in-left">
                            ...
                            <p>We know that a temporary fix isn&apos;t what families need. Instead, we focus on work that stands up over time, supported by warranties and driven by a mindset that values durability, safety, and reliability.</p>
                        ...
                        <div className="content-text fade-in-right">
                            ...
                            <p>Trust is earned, not claimed—and for us, it has been earned through thousands of service visits where homeowners saw firsthand how we treat their concerns as our own.</p>
