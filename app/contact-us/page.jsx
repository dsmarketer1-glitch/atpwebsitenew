                ...
                <div className="container">
                    <div className="contact-grid">
                        ...
                        <div className="fade-in-right">
                            ...
                            <div className="contact-info-card">
                                <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><IconMapPin size={18} /> Garland Location</h3>
                                <div className="contact-info-item">
                                    <span className="contact-info-icon"><IconPhone size={18} /></span>
                                ...
                                <div className="contact-info-item">
                                    <span className="contact-info-icon"><IconMapPin size={18} /></span>
                                    <a href="https://www.google.com/maps/place/102+N+Shiloh+Rd+Unit+104,+Garland,+TX+75042" target="_blank" rel="noopener noreferrer">
                                        102 N Shiloh Rd, Unit 104, Garland, TX 75042
                                    </a>
                                </div>
                                <div className="map-embed">
                                    <iframe
                                        src="https://www.google.com/maps?q=102%20N%20Shiloh%20Rd%20Unit%20104%2C%20Garland%2C%20TX%2075042&output=embed"
